...
在注册、使用来推SSP媒体服务系统前，请您认真阅读本协议条款及条件。参加来推SSP媒体服务系统即表明您接受了本协议条款及条件。如果您不接受本协议条款及条件，则暂时无法使用来推SSP媒体服务系统。

您与杭州百泰文化有限公司公司（以下简称“来推”）的本协议（“协议”）构成来推SSP媒体服务系统的标准条款及条件。“您”或“您的”指注册表格中登记的任何实体，该注册表格由该实体或其关联方、任何代理机构、网络或其他您授权可访问您账户和/或计划资料（定义如下）的第三方来提交，其亦应受本协议条款及条件的约束。来推有权随时修改本协议，只需公示于来推网站相关页面等，而无需征得您的事先同意，请您注意留意更新版本。修改后的条款于公示之时生效。在来推修改协议条款后，如果您不接受修改后的条款，请您立即停止使用来推SSP媒体服务系统，您继续使用来推SSP媒体服务系统将被视为您已接受了修改后的条款。

## 第一条 定义

1. 来推SSP媒体服务系统：是一款面向媒体用户的媒体管理软件。本系统仅为中立的技术工具。
2. “用户”或“您”：是指在来推注册SSP媒体服务系统的网站媒体注册用户，通过来推提供的获取软件授权并获得软件产品使用许可的个人或单一实体。

## 第二条 用户的权利与义务

1. 用户保证从正规渠道获取来推SSP媒体服务，用户需凭来推SSP媒体服务系统账户、密码，使用来推SSP媒体服务。用户应自行管理账号和密码，用户承担账号、密码的保管责任，并就账号、密码项下之一切活动承担责任。
2. 用户应使用来推SSP媒体管理系统对来推SSP媒体服务系统账户内的信息进行修改。
3. 用户保证来推SSP媒体服务系统账号注册时，所提供的资料真实无误。如因用户提供虚假信息，造成的损失由用户承担。用户账号归来推所有，用户仅享有账号的使用权。
4. 用户保证在其来推SSP媒体服务系统账号、密码未授权使用、或者发生其他任何安全问题时，应立即通知来推。
5. 用户必须通过其正确的系统登录并使用来推SSP媒体服务系统，通过其他形式登录、使用来推SSP媒体服务系统所造成的后果，来推将不承担任何责任。用户保证对其自身的操作以及其任何后果负责，不得破坏本软件的知识产权。
6. 本软件仅提供中立的技术服务，用户承诺合法使用来推SSP媒体服务系统以及相关功能，保证不得利用来推SSP媒体服务系统从事违反国家相关法律法规的一切活动，包括但不限于：
   1. 使用服务端软件上载、传送、存储或以其它方法散布任何非法的、诽谤的、骚扰性的、侮辱性的、欺诈的、淫秽的或含有病毒的、或其它违法不妥当的内容；
   2. 上载、传送或散布侵犯其他方知识产权或其它所有权、合同或信托权利或义务的内容；
   3. 阻止他人使用该软件；
   4. 为任何欺诈或不当目的使用服务；
   5. 通过来推SSP媒体服务软件误导或欺骗他人；
   6. 发布、传播违反国家法律、扰乱国家社会稳定的内容；
   7. 发布、传播侵犯他人知识产权、商业秘密等合法权利的内容；
   8. 进行危害计算机网络安全的行为。来推若一经发现，有权不经通知用户情况下，予以删除上述非法内容。
7. 除非得到来推的书面授权，任何用户不得对来推SSP媒体服务软件通过复制、翻译、修改、反汇编、出售、转租等形式进行破坏，以及将软件用作他用。
8. 费用支付问题，来推会在相关地方明示。目前来推SSP媒体服务系统为免费软件。
9. 用户了解来推SSP媒体服务中可能包含由第三方提供的服务，来推只是为了用户的便利而提供功能模块。用户使用第三方提供的服务，需与第三方另行达成服务协议，支付相应的费用并承担可能的风险。来推对第三方所提供的服务不承担任何形式的担保。
10. 用户完全了解并理解来推SSP媒体服务系统的推广物料，系由第三方上传，可能存在法律风险，用户在发布、编辑这些推广物料之前，已充分审查考虑此风险，由此所产生的法律后果完全由用户自行承担。
11. 用户承诺对来推SSP媒体服务系统仅用于媒体发布、编辑等使用，不用于其他目的或用途，若一经来推发现，来推有权取消该用户的权限，并不予任何补偿。

## 第三条 来推的权利和义务

1. 本软件不含有任何破坏用户计算机数据和获取用户隐私信息的恶意代码，不含有任何跟踪、监视用户计算机和或操作行为的功能代码，不会监控用户网上、网下行为或泄露用户隐私。
2. 来推不会将您的个人信息转移或披露给任何非关联的第三方，除非：
   1. 相关法律法规或法院、政府机关要求；
   2. 为完成合并、分立、收购或资产转让而转移；或
   3. 为提供您要求的服务所必需；
   4. 用户在使用本软件时，同意将其自身的信息公开。用户保证自行承担因此可能产生的风险，来推不承担因此所造成的一切损失；
   5. 由于来推以外其他渠道被他人获知的信息，这些渠道并不受保密义务的限制；
3. 来推会建立安全体系，最大化保护用户的利益，但来推也无法杜绝非安全的其他因素存在。用户在此了解并同意来推对此所作出的一切努力，并同意不向来推追究因此所造成的一切损失。
4. 来推对任何服务与该客户端软件或任何其他客户端软件的可用性、及时性、安全性或可靠性不承担任何责任或义务。
5. 来推可能会对服务内容进行变更，也可能会中断、中止或终止服务。
6. 您理解并同意，来推有权自主决定经营策略。在来推发生合并、分立、收购、资产转让时，来推可向第三方转让本服务下相关资产；来推也可在单方通知您后，将本协议下部分或全部服务转交由第三方运营或履行。具体受让主体以来推通知的为准。
7. 如发生下列任何一种情形，来推有权不经通知而中断或终止向您提供的服务：
   1. 根据法律规定您应提交真实信息，而您提供的个人资料不真实、或与注册时信息不一致又未能提供合理证明；
   2. 您违反相关法律法规或本协议的约定；
   3. 按照法律规定或主管部门的要求；
   4. 出于安全的原因或其他必要的情形。
8. 若您未按时足额付费，来推有权中断、中止或终止提供服务。
9. 您有责任自行备份存储在本服务中的数据。如果您的服务被终止，来推可以从服务器上永久地删除您的数据,但法律法规另有规定的除外。服务终止后，来推没有义务向您返还数据。
